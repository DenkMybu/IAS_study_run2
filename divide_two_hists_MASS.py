...
if __name__ == "__main__":
     ...
     str_num = "HSCP_Mass_Single_ihcut_ptsupp50_qtl_80_90_ias"
     str_denom = "HSCP_Mass_Triple_ihcut_ptsupp50_qtl_80_90_ias"
     ...
     hist_num.GetXaxis().SetTitle("P [GeV/c]")
     ...
     hist_denom.GetXaxis().SetTitle("P [GeV/c]")

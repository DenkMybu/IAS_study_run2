...
if __name__ == "__main__":
     ...
     hfile = TFile( 'PE_templates_2018A_HSCP_noiso.root', 'RECREATE' )
     ...
     for i in range(nPE):
         ...
         poissonHisto(PE_templates[i],AllIncTemplate,RNG,nb_pct)
         ...
         poissonHisto(PE_templates_0_20[i],Tpt_PU_0_20,RNG,nb_pct)
         ...
         poissonHisto(PE_templates_20_25[i],Tpt_PU_20_25,RNG,nb_pct)
         ...
         poissonHisto(PE_templates_25_30[i],Tpt_PU_25_30,RNG,nb_pct)
         ...
         poissonHisto(PE_templates_30_35[i],Tpt_PU_30_35,RNG,nb_pct)
         ...
         poissonHisto(PE_templates_35_99[i],Tpt_PU_35_99,RNG,nb_pct)
